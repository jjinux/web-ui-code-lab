...
$$.ChatConnection = {"":
 ...
 _init$1: function(retrySeconds) {
  ...
  $.add$1(this.webSocket.get$on().get$close(), new $.ChatConnection__init_anon0(this, retrySeconds, t1));
  $.add$1(this.webSocket.get$on().get$error(), new $.ChatConnection__init_anon1(this, retrySeconds, t1));
...
$$.ChatConnection__init_anon0 = {"":
 ...
 call$1: function(e) {
  ...
  if (t1.encounteredError_1 !== true) {
    var t3 = $.window();
    var t4 = new $.ChatConnection__init_anon4(this.this_3, t2);
    if (typeof t2 !== 'number')
      throw $.iae(t2);
...
$$.ChatConnection__init_anon1 = {"":
 ...
 call$1: function(e) {
  ...
  if (t1.encounteredError_1 !== true) {
    var t2 = $.window();
    var t3 = this.this_7;
    var t4 = this.retrySeconds_6;
    t3 = new $.ChatConnection__init_anon3(t3, t4);
    if (typeof t4 !== 'number')
      throw $.iae(t4);
...
$.CTC20 = 'structured clone of other type';
...
$.CTC15 = new Isolate.$isolateProperties.JsonUnsupportedObjectType();
$.CTC26 = false;
$.CTC27 = '^#[_a-zA-Z]\\w*$';
...
$.CTC30 = 'structured clone of RegExp';
